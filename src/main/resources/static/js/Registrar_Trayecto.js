...
const tramoVehiculoParticular = `<formid="formularioVehiculoParticular"><h3>Datosdeltramo</h3><br><h5>Lugardesalida</h5><br><divclass="top-row"><divclass="field-wrap"><label>Tipodedirección<spanclass="req">*</span></label><br><br><selectclass="select-css"name="TipoDireccionSalida"id="TipoDireccionSalida"><optionvalue="0">Seleccioneeltipodedirección</option><optionvalue="Vivienda">Vivienda</option><optionvalue="Trabajo">Trabajo</option><optionvalue="Otro">Otro</option></select></div></div><divclass="top-row"><divclass="field-wrap"><label>Calle<spanclass="req">*</span></label><br><br><inputtype="text"requiredautocomplete="off"name="CalleSalida"/></div><divclass="field-wrap"><label>Altura<spanclass="req">*</span></label><br><br><inputtype="text"requiredautocomplete="off"name="AlturaSalida"/></div></div><divclass="top-row"><divclass="field-wrap"><label>Localidad<spanclass="req">*</span></label><br><br><inputtype="text"requiredautocomplete="off"name="LocalidadSalida"/></div><divclass="field-wrap"><label>Municipio<spanclass="req">*</span></label><br><br><inputtype="text"requiredautocomplete="off"name="MunicipioSalida"/></div></div><divclass="top-row"><divclass="field-wrap"><label>Provincia<spanclass="req">*</span></label><br><br><inputtype="text"requiredautocomplete="off"name="ProvinciaSalida"/></div><divclass="field-wrap"><label>Pais<spanclass="req">*</span></label><br><br><inputtype="text"requiredautocomplete="off"name="PaisSalida"/></div></div><h5>Lugardellegada</h5><br><divclass="top-row"><divclass="field-wrap"><label>Tipodedirección<spanclass="req">*</span></label><br><br><selectclass="select-css"name="TipoDireccionLlegada"id="TipoDireccionLlegada"><optionvalue="0">Seleccioneeltipodedirección</option><optionvalue="Vivienda">Vivienda</option>
