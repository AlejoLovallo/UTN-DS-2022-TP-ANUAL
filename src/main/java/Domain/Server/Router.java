...
public class Router {
  ...
  private static void configure(){
    ...
    Spark.get("/crearSectorHTML", organizacionController::crearSectorHTML, Router.engine);
    ...
    Spark.post("/crearSector",organizacionController::crearSector);
    ...
    Spark.get("/direccionesGet", organizacionController::getAllDirecciones);
